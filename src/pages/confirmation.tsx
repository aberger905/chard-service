...
const Confirmation = () => {
  ...
  return (
    ...
    <div className='flex flex-col justify-center items-center min-h-screen fadeUp'>
      ...
      <p className='text-center text-lg text-gray-600'>We appreciate your contribution to our storytelling journey. Your story is now in the hands of our dedicated team, and we're eager to bring it to life. Keep an eye on your inbox for updates and the big reveal of your completed article!</p>
    </div>
    </div>
