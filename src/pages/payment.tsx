...
const Payment: React.FC = () => {
  ...
  return (
    ...
    <h1 className='text-5xl font-bold text-center pt-5 font-anton fadeUp'>Your Story Awaits its Spotlight.</h1>
    <h2 className='text-xl font-semibold text-center mb-10 font-anton fadeUp'>Unlock the power of your narrative.</h2>
    <div className='flex flex-col md:flex-row justify-center items-center'>
      <div className='bg-white flex flex-col justify-center items-center border shadow-sm rounded-lg p-5 w-72 fadeUp'>
        ...
        <button onClick={handleClick} disabled={isLoading} className='border transition rounded-lg bg-slate-800 hover:bg-slate-600 text-white px-5 py-2 font-bold w-[90%]'>{isLoading ? <div className='flex justify-center items-center'><FaSpinner className='animate-spin'/></div> : 'Continue'}</button>
