import banner from '../../assets/writer.svg'
...
const RevisionConfirmation = () => {
  ...
  return (
    ...
    <div className='flex flex-col justify-center items-center min-h-screen'>
      ...
      <p className='text-center text-xl font-anton'>Thank you for your valuable feedback. Our team is now diving back into your story with your revision notes in hand. We understand the importance of getting every detail just right and are committed to refining your article to better reflect your vision. Please be patient as this process may take some time, but rest assured, we're working diligently to perfect your story.</p>
      <br />
